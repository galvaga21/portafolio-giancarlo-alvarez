...
const submitForm = () => {
  console.log('Validando Login...', formParams.value.email)
  ...
  <div class="flex-1 flex flex-col md:flex-row w-full min-h-screen">
    ...
    <div class="hidden md:flex md:w-1/2 lg:w-7/12 bg-gradient-to-br from-indigo-900 via-slate-900 to-slate-900 relative items-center justify-center overflow-hidden">
      ...
      <div class="absolute inset-0 z-0">
        ...
        <div class="absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-500/10 rounded-full blur-[100px]"></div>
      </div>

      <div class="relative z-10 w-full max-w-lg px-12 animate-fade-in-up delay-300">
